...
The [Google Compute Platform (GCP) cloud](https://cloud.google.com/) provides powerful computational resources for big data analysis. 
This tutorial explains how to run a batch of compute jobs on the Google Compute Platform (GCP) cloud using kubernetes, docker, and gcsfuse. 
...
https://console.cloud.google.com/iam-admin/serviceaccounts?project=**[add your project id here]**
